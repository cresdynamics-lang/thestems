...
const hamperFallback: Product[] = [
  {
    id: "same-day-hamper-signature",
    slug: "signature-celebration-basket",
    title: "Signature Celebration Basket",
    description: "Same-day gift hamper with curated items",
    short_description: "Same-day gift hamper with curated items",
    price: 1050000,
    category: "hampers",
    tags: ["same-day"],
...
export default async function SameDayFlowerDeliveryNairobiPage() {
